...
const BannerCarousel = () => {
  ...
  const [isVideoLoadedOnce, setIsVideoLoadedOnce] = useState(false); // Track if video has loaded once
  ...
  useEffect(() => {
    ...
    const handleLoadedMetadata = () => {
      if (video) {
        ...
        setIsVideoLoadedOnce(true); // Mark that the video has loaded once
      }
    };
          ...
          <SwiperSlide key={i}>
            <div className='h-full w-full flex relative'>
              ...
              <div className='absolute h-full w-full md:flex'>
                ...
                <img
                  className="h-fit w-full mt-44 md:mt-0" style={{objectFit: 'contain'}}
